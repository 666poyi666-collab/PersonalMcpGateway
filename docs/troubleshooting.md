...
gateway with a degraded Watch module normally means phone/watch discovery, pairing, or LAN access
failed. A healthy gateway with an unavailable ChatGPT app normally means the tunnel, workspace
association, runtime key, or developer-mode app needs attention.
